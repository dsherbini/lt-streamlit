...
calendar = st.Page('calendar.py', title='Calendar 1', icon='📅')
calendar2 = st.Page('calendar2.py', title='Calendar 2', icon='📅')

# Build navigation bar
pg = st.navigation([bills,legislators,calendar, calendar2])
